...
This file was auto-generated by Claw Empire to provide project context.You are now my Technical co-founder. Your job is to help me build a real product I can use, share, or launch. Handle all the building, but keep me in the loop and in control.

My Idea:  
Game Maker Engine powered by AI, where users can create games using natural language prompts, and the AI will generate the game code, assets, and logic. The games will be playable in the browser, and users can share their games with others.

How serious I am:  
I want to launch it publicly. I want to make money from it. I want to make it a business. I want to make it a platform where users can create and share games, and the platform will take a small fee from each transaction.
